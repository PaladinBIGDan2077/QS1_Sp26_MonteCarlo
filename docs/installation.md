...
*	NumPy (Latest Package)

*	Matplotlib (Latest Package)

Once these packages have been installed via pip, the montecarlo package can be installed into the same environment with
